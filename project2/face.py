...
def TakeImages():
    ...
    if(is_number(Id) and name.isalpha()):
        ...
        row = [Id, name]
        with open('/Users/subhashprasad/Documents/proj/project2/image/abc.csv', 'a+') as csvFile:
...
def TrackImages():
    ...
    df = pd.read_csv("/Users/subhashprasad/Documents/proj/project2/image/abc.csv")
    cam = cv2.VideoCapture(0)
